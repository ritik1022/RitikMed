...
public class AdminController {
    ...
    public Boolean addMedicine(@RequestBody @Valid Medicine f) {
    ...
    public Boolean updateMedicine(@PathVariable int id,@RequestBody @Valid Medicine f) {
    ...
    @GetMapping("/byid/{medicineId}")
    public ResponseEntity<Medicine> viewMedicineById(@PathVariable(value = "medicineId") int medicineId) throws MedicineIdDoesNotExistException{
    return new ResponseEntity<Medicine>(medicineservice.viewMedicineById(medicineId), HttpStatus.OK);
}
